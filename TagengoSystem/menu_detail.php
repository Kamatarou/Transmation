          ...
          <tr>
            ...
            <td style="text-align: center;">
              <form action="menu.php" method="POST">
                ...
                <input type="hidden" name="description_no" value="<?= $description_no ?>">
                <input type="hidden" name="language" value="ja">
                <input type="submit" style="font-size: 1em;" value="前の画面へ戻る">
              </form>
            </td>
          </tr>
        </table>
          ...
          <tr>
            ...
            <td style="text-align: center;">
              <form action="foodmenu_retranslate.php" method="POST">
                ...
                <input type="hidden" name="detail" value="<?= $result['detail'] ?>">
                <input type="hidden" name="price" value="<?= $result['price'] ?>">
                <input type="submit" style="font-size: 1em;" value="日本語に再翻訳">
              </form>
            </td>
            <td style="text-align: center;">
              <form action="menu.php" method="POST">
        ...
        <tr>
          <td>
            <form action="menu.php" method="POST">
              ...
              <input type="hidden" name="description_no" value="<?= $description_no ?>">
              <input type="hidden" name="language" value="<?= $language ?>">
              <input type="submit" style="font-size: 20px;" value="<?= $back[$language] ?>">
            </form>
          </td>
          <td style="text-align: center;">
            <form action="missTrans.php" method="POST">
              <input type="hidden" name="user_no" value="<?= $user_no ?>">
              <input type="hidden" name="description_no" value="<?= $description_no ?>">
              <input type="hidden" name="menu_no" value="<?= $menu_no ?>">
              <input type="hidden" name="language" value="<?= $language ?>">
              <input type="hidden" name="style" value="1">
              <input type="submit" style="font-size: 20px;" value="<?= $missTrans[$language] ?>">
            </form>
          </td>
        </tr>
      </table>
